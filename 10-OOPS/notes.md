...
- Prototype is basically an object that is attached to anything we create in JavaScript
  
- **values.__proto__ === datatype.prototype**
...
### 3) If you want to know what hidden properties and methods are stored in a prototype object?
...
### 4) what if I want to know the hidden properties of a object declared in the code? 
...
### 5)What is difference between [[Prototype]] and _proto_ and prototype?
**Ans :** All are objects.
...
- since all objects in javascript point to the default Object.prototype, the Object.prototype points to null.
-  To verify if its point to null or not see inside **Object.prototype._proto_ === null**
...
### Q4) What is prototype chain and prototype inheritence in javascript?
